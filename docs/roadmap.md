...
- **EPIC-009 — El contexto que el usuario pone a una vigilada: la nota y los enlaces**
  (estado: **aprobada** el 2026-09-13 por el humano; nace el 2026-09-12 a petición suya, con
  sus palabras dentro del documento de la épica).
  **Qué entrega.** Que una vigilada lleve encima **por qué se vigila**: una nota del usuario
  ...
  Hoy la app guarda sus **números** —las zonas— y tira su **razonamiento**: lo único que un
  usuario puede escribir sobre una acción son los cuatro límites de sus zonas.
  ...
  **Cuelga del símbolo del usuario, no de la fila de vigilada** (decisión del humano del
  ...
  ⚠️ **Adelanta a SPEC-045**, que sigue aprobada y sin implementar desde el 2026-08-21 y que
  toca el **mismo panel** de `/vigiladas`. La alternativa —esperar a SPEC-045— se puso sobre
  la mesa en el gate y **se descartó** (humano, 2026-09-13). Quien llegue el segundo rebasa y
  reconcilia; el panel no se rediseña, se le añade un sitio (R-2 de la épica).
