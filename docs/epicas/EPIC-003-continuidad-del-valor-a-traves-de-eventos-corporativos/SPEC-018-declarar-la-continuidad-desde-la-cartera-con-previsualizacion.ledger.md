...
epica: EPIC-003
---
# Ledger — SPEC-018 Declarar la continuidad desde la cartera con previsualizacion

## Resumen
- Fase: <!-- refleja el estado de la spec; la fuente de verdad es el frontmatter de la spec -->
- Rama: `ft/SPEC-018-declarar-la-continuidad-desde-la-cartera-con-previsualizacion`
