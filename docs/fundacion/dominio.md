...
| Aviso / Notificación proactiva | Comunicación que la app envía al usuario cuando se produce un disparo, sin que este tenga que abrir la app. | Canal a decidir en spec (email/push/in-app); objetivo 100 % de disparos notificados (CE-2; R-4). |
